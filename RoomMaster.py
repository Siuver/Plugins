...
DATA_PATH = os.path.join(os.path.abspath(os.path.dirname(__file__)), "Plugins", "data.json").replace('\\', '/')
...
WEAPON_NAME = ['火斧', '火弩', '扫把#火杖', '风矛#风枪', '风镖#风飞镖', '风环', '水爪', '水枪', '水书', '光剑', '光铳#光枪',
               '光灯', '暗刀', '暗机枪', '吉他', '混刷#杂图', '局地#局矿', '废矿', '火矿#火废', '水矿#水废', '风矿#风废', '光矿#光废', '暗矿#暗废', '火武#火图', '水武#水图', '风武#风图', '光武#光图', '暗武#暗图']
